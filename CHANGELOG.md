...
* add abort signal support to inference operations ([f3e545e](https://github.com/emrantusho/vibesdk-project/commit/f3e545e742b7b4cedb4c74b3af9501327ee8a8b3))
* add agent-specific model constraints and refactor generation ([3f9ccf7](https://github.com/emrantusho/vibesdk-project/commit/3f9ccf7b3b1b137d6255493da14f8463ce8a66f3))
* add ai-based project type detection and workflow support ([f753f8b](https://github.com/emrantusho/vibesdk-project/commit/f753f8bc1dc587de106dc1b413c11fc796cbd7cb))
* add ai-based project type detection and workflow support ([2aea3c7](https://github.com/emrantusho/vibesdk-project/commit/2aea3c7ab3ddad9e20847567bc67960b155f7cef))
* add app visibility check for preview deployment ([3c4f203](https://github.com/emrantusho/vibesdk-project/commit/3c4f2030d730e95fe0bd8deb17b1265cd5f20ecf))
* add automated PR description generation workflow ([3c81d5d](https://github.com/emrantusho/vibesdk-project/commit/3c81d5d486a244ca9dfcf40495641dedea3d453a))
* add automated PR workflows and commit validation ([5ba22fc](https://github.com/emrantusho/vibesdk-project/commit/5ba22fce6f707c9b05f39bdeee291f7464d8b0bb))
* add blueprint parsing utilities and enhanced session state tracking to SDK ([96168d5](https://github.com/emrantusho/vibesdk-project/commit/96168d54ebf8352af9bfdf9113f04a3df5aaf90b))
* add bootstrap script and template customization ([1fa893f](https://github.com/emrantusho/vibesdk-project/commit/1fa893fe72f709587c7a6080d37076015dacd7c2))
* add common pitfalls and dependency documentation to phase implementation prompt ([0184e5f](https://github.com/emrantusho/vibesdk-project/commit/0184e5fadf4f8c2a0f31d6e11853b7cd2115e5b1))
* add completion detection and dependency-aware tool execution ([0f85a7d](https://github.com/emrantusho/vibesdk-project/commit/0f85a7d00934cbc3ec4beb706689cbda93478fb8))
* add completion detection and dependency-aware tool execution ([be72055](https://github.com/emrantusho/vibesdk-project/commit/be720550bdf97f85635bd3bdeceb4fecd31341d3))
* add completion detection and loop prevention to agentic builder and debugger ([e926e18](https://github.com/emrantusho/vibesdk-project/commit/e926e18b1bbce27f53df7758d46929426e056e07))
* add completion detection and loop prevention to agentic builder and debugger ([219d2c7](https://github.com/emrantusho/vibesdk-project/commit/219d2c7c464544ebe5477ab36192be2d15ae3bbe))
* add concurrency control and cleanup for Claude review workflow ([b5a76da](https://github.com/emrantusho/vibesdk-project/commit/b5a76dae70febd9c624ab75f4f0e117c044c5c4e))
* add dedicated AI changelog workflow and improve release-please gating ([4e97d5a](https://github.com/emrantusho/vibesdk-project/commit/4e97d5a8e1e85be02d04bf3c62a00d2ab8ff5f62))
* add deep debug session management with state persistence and wait tools ([e60694f](https://github.com/emrantusho/vibesdk-project/commit/e60694f6334b2c05acd1c7147650fc88c9adbd61))
* add diff toggle option to git show command ([2657ba9](https://github.com/emrantusho/vibesdk-project/commit/2657ba9706a65cd0c6bb7e7dfeaf23265c24e035))
* add feature modules and capabilities discovery ([0534a95](https://github.com/emrantusho/vibesdk-project/commit/0534a955f40682cd0163ed315a4963cfde0cf1b4))
* add force refresh mechanism for preview deployments ([796e34d](https://github.com/emrantusho/vibesdk-project/commit/796e34d3459657502599bdbfdeddc1144289c0e3))
* add generate_files tool for creating new files and full rewrites ([52d917f](https://github.com/emrantusho/vibesdk-project/commit/52d917f2f6ff39f2ea047f494cf579e28dab9a31))
* add Git clone functionality for repositories ([d7532f2](https://github.com/emrantusho/vibesdk-project/commit/d7532f225d6ff6fb4e9439ea02619338ac5e5207))
* add git clone protocol support with template rebasing ([6005c4d](https://github.com/emrantusho/vibesdk-project/commit/6005c4dea9fe15ee03f8a77edbba950081dd176e))
* add git version control tools and enhance debugging system ([f6b6b00](https://github.com/emrantusho/vibesdk-project/commit/f6b6b0076d0ef57ef120a0a15b6493ecb616f020))
* add GitHub Actions for issue triage + improved code-review ([d42f805](https://github.com/emrantusho/vibesdk-project/commit/d42f8050b3b3a53a4f2e5e612e156aea534cb71d))
* add HTTP retry logic with exponential backoff to SDK client ([b02025e](https://github.com/emrantusho/vibesdk-project/commit/b02025e050adc6c6c7fa324211743b63efe6df49))
* add in-memory caching for git clone operations with 5s TTL ([263ac37](https://github.com/emrantusho/vibesdk-project/commit/263ac37b3d0289f5b0ca3c1eda8273a001088321))
* add incremental GitHub sync with commit history preservation ([4785472](https://github.com/emrantusho/vibesdk-project/commit/4785472f0664b946714ef180727bc6427cbc8843))
* add inference cancellation support with AbortController ([6e752c2](https://github.com/emrantusho/vibesdk-project/commit/6e752c214197ec755c988ee0308721d1f04b50fb))
* add integration test controls and exclude from pre-commit hooks ([e68369b](https://github.com/emrantusho/vibesdk-project/commit/e68369b9e61b4eb7ad56b30d4c39c2b55d437fd2))
* add llm.md and update claude.md using it ([a1e90dd](https://github.com/emrantusho/vibesdk-project/commit/a1e90ddfe398714ca9f4af75e57ea935b184060b))
* add log file extractor tool and nanoid dependency ([0b12d76](https://github.com/emrantusho/vibesdk-project/commit/0b12d76b7fbea3d7ea9e7863e9bb6be0d0cde27f))
* add missing environment variables to .prod.vars template generation ([7127cad](https://github.com/emrantusho/vibesdk-project/commit/7127cadd0c7a8b2b456c7e7bd79371af98f8d3b8))
* add missing environment variables to deployment workflow and script ([965381c](https://github.com/emrantusho/vibesdk-project/commit/965381ca7e47bd138656cb50d47ecd32a388ff6f))
* add new model definitions ([e73a089](https://github.com/emrantusho/vibesdk-project/commit/e73a08928021823068d5dc2ece0a97d303b30504))
* add persistent command execution in sandbox environment ([7d02a43](https://github.com/emrantusho/vibesdk-project/commit/7d02a43669414185bed002ddc3baff463e15753d))
* add phase timeline change subscription and event handling ([a1c7404](https://github.com/emrantusho/vibesdk-project/commit/a1c740411d7b183d26b334d4c5a2a80ab4905728))
* add phase timeline change subscription and event handling ([f8b14cd](https://github.com/emrantusho/vibesdk-project/commit/f8b14cde831e284d478633154189e5032dce3506))
* add pre-deploy safety gate with automated code fixing ([611eb8e](https://github.com/emrantusho/vibesdk-project/commit/611eb8e5bb0cc3c9c3ea56efb7578a3d5117d177))
* add presentation and documentation preview modes ([#234](https://github.com/emrantusho/vibesdk-project/issues/234)) ([e9a31da](https://github.com/emrantusho/vibesdk-project/commit/e9a31da370bcf82769ccb85b2286437e63dfc695))
* add previous debug session context and improve error handling in debugging tools ([45ac910](https://github.com/emrantusho/vibesdk-project/commit/45ac9105ad920e36cd7b284a050a414c1913a2a6))
* add project mode selector with agentic behavior support ([b34c707](https://github.com/emrantusho/vibesdk-project/commit/b34c7079153ee0455a2d2b650a4256365a11e9d7))
* add project mode selector with agentic behavior support ([f5a3be6](https://github.com/emrantusho/vibesdk-project/commit/f5a3be60bfdb2f19861611fa88f2f32207f75859))
* add project name generation and config file updates ([a948e62](https://github.com/emrantusho/vibesdk-project/commit/a948e62b29999f3dca31b0262438fa3608c9df35))
* add query length validation with 20k character limit ([8927bf0](https://github.com/emrantusho/vibesdk-project/commit/8927bf01b48ff4357a1d2e46cb5cb518ef9cbde4))
* add query length validation with 20k character limit ([715d21f](https://github.com/emrantusho/vibesdk-project/commit/715d21fca5a2ac04972d9b7eea600471b81663b9))
* add read-only mode for agent initialization ([7f83e19](https://github.com/emrantusho/vibesdk-project/commit/7f83e1975f72a7e1df90a6b661a45f553a882176))
* add release-live deployment workflow and vitest bun:test alias ([a71e382](https://github.com/emrantusho/vibesdk-project/commit/a71e3826bf011c90bdbd89d26a0ab3a8bd0edc7c))
* add retry logic and blank screenshot detection for browser rendering ([c30a422](https://github.com/emrantusho/vibesdk-project/commit/c30a422fa606bac5480ba7bca8cc31178e08db6d))
* add SDK documentation and usage example to main README ([3b11517](https://github.com/emrantusho/vibesdk-project/commit/3b11517310cd4fc5594cdab4caf1316ea7b4e9ce))
* add stop generation button and handle cancelled state in phase timeline ([3cd7cab](https://github.com/emrantusho/vibesdk-project/commit/3cd7cabed64f8cbd012f12f63b5be6355b9a51e4))
* add streaming support to deep debugger and enhance logs tool with truncation ([1bdb1e7](https://github.com/emrantusho/vibesdk-project/commit/1bdb1e7e97c6a18ae3c3a2c69b8c14e6fdd65a19))
* add timeout handling and force redeploy option ([d2543d5](https://github.com/emrantusho/vibesdk-project/commit/d2543d5e575c45b141bb8728eeb10e3674fceb13))
* add user secrets management with durable objects ([12d2132](https://github.com/emrantusho/vibesdk-project/commit/12d2132942aba41ac9afb312c901c636d9febf27))
* add wait_for_generation tool and enhance tool call result handling ([92f4e0e](https://github.com/emrantusho/vibesdk-project/commit/92f4e0e5192efd8ca0154e7d28ba6fd1f046a8da))
* add WebSocket support for sandbox proxy ([9d9d60b](https://github.com/emrantusho/vibesdk-project/commit/9d9d60b3313eee2f58e2e50fe19fdfd44ab99511))
* add WebSocket support for sandbox proxy ([72538be](https://github.com/emrantusho/vibesdk-project/commit/72538be52c99345a3fa20ec36e91a0eb274ce718))
* added user secrets store tests ([b26bbb6](https://github.com/emrantusho/vibesdk-project/commit/b26bbb6f7eb70af98b073220219db84179c46086))
* agentic streaming presentations finally working ([00fc51c](https://github.com/emrantusho/vibesdk-project/commit/00fc51cfb6e729409f530f1b14b1b601b18fdaab))
* alter template schema to return map instead of list of files ([fad85df](https://github.com/emrantusho/vibesdk-project/commit/fad85df3b1385426fb3892d74fb97f9f4dd2d52d))
* bug fixes + save manifest and slides proactively upon generation ([ff47fc8](https://github.com/emrantusho/vibesdk-project/commit/ff47fc8b2f4df9921eb0f278bb7942d15849746a))
* change the official preview domain to cloudflarepreviews.net ([516f92c](https://github.com/emrantusho/vibesdk-project/commit/516f92cbc5ac94024ae5a933cd3aa93b29b666fd))
* client sdk + tests + docs ([46d7769](https://github.com/emrantusho/vibesdk-project/commit/46d7769bc12253a4240c5b447772f0391d8f28c3))
* code deep debugger prompt tweaks ([394a720](https://github.com/emrantusho/vibesdk-project/commit/394a720fadb9db067f343b42e344c65d471da67d))
* Cost optimizations via model configs and prompt improvements ([#247](https://github.com/emrantusho/vibesdk-project/issues/247)) ([2b3a901](https://github.com/emrantusho/vibesdk-project/commit/2b3a90149d336a1dc5aab6a7e4f999461cf147d3))
* display completion message when entering finalization phase ([1365eeb](https://github.com/emrantusho/vibesdk-project/commit/1365eebae9fc150a91d048bae2e6b5cf11cda350))
* DO based git, fs storage, commit every saved file ([2156e89](https://github.com/emrantusho/vibesdk-project/commit/2156e89a22280fc7d16483e9d50ec635f0bfb2a0))
* enable Agent SDK for all Claude Code Action workflows ([4aa6f5f](https://github.com/emrantusho/vibesdk-project/commit/4aa6f5f12ab2050930a759d44b1260d6af2103b8))
* enforce template write-protection in simple code generator ([4f0dccf](https://github.com/emrantusho/vibesdk-project/commit/4f0dccf60661a6ae7ca09fd696270a0152316ea1))
* enhance bootstrap command validation and safety ([ed1c006](https://github.com/emrantusho/vibesdk-project/commit/ed1c00642d452632d2aebdbc22d1c855f7bd7692))
* enhance changelog generation with detailed PR and commit data ([8950852](https://github.com/emrantusho/vibesdk-project/commit/89508523afada3f9522cdc19b994006b4e878a15))
* enhance changelog generation with detailed PR and commit data ([7850fc6](https://github.com/emrantusho/vibesdk-project/commit/7850fc620cf56372ab364711b1479a65279e5e32))
* enhance changelog generation with detailed PR and commit data ([01afb74](https://github.com/emrantusho/vibesdk-project/commit/01afb7410b3cd5e0a5bb228d9aad238e9b1d3985))
* enhance CI/CD workflows with security and automation improvements ([d86377e](https://github.com/emrantusho/vibesdk-project/commit/d86377eebfe5d2086f9b9700ea241bec17ae5129))
* enhance Claude review workflow with comment-based triggers and sticky comments ([9716c42](https://github.com/emrantusho/vibesdk-project/commit/9716c42988338e3026627483680777d9e91abbfb))
* enhance Claude review workflow with improved PR description handling and streamlined review process ([6f6dc84](https://github.com/emrantusho/vibesdk-project/commit/6f6dc84c11e724f320e3ac2b6d6d8dc224361381))
* enhance debugging tools with user interaction handling and runtime error detection ([b144e2c](https://github.com/emrantusho/vibesdk-project/commit/b144e2c8b63bdf803f28b0ad85f8183ae6281316))
* enhance deep debug session management and UI ([2188c90](https://github.com/emrantusho/vibesdk-project/commit/2188c90b1fecc5571ec011696f6d3f4b1e5fbd4f))
* enhance git integration with safer command access ([3c9696f](https://github.com/emrantusho/vibesdk-project/commit/3c9696f96faa27e89e025c0bd7d13c230e73ff13))
* enhance git show command with diff support and optimize message handling ([fd70b1c](https://github.com/emrantusho/vibesdk-project/commit/fd70b1c7673c3b7d84f3056167e95625098c10da))
* enhance phase timeline with debugging status and issue tracking ([79fb107](https://github.com/emrantusho/vibesdk-project/commit/79fb1071524cd654750f978332f6acc0d1ac4c2a))
* enhance PR description workflow with review capabilities ([433c398](https://github.com/emrantusho/vibesdk-project/commit/433c398b4ab9e7afb55d2c602a62c1a00ea0d896))
* enhance PR review automation with issue linking and feedback ([04720aa](https://github.com/emrantusho/vibesdk-project/commit/04720aa280c36725479941212d69c4b6305bbc17))
* enhance PR review workflow with unified analysis ([b321376](https://github.com/emrantusho/vibesdk-project/commit/b3213764e02fcebd19858d2036bc3db245ed0bde))
* enhance rate limit result with exceeded limit details and limit values ([aceac60](https://github.com/emrantusho/vibesdk-project/commit/aceac6076d51c0d744582ebe7f9f6ce3b08b73ad))
* enhance rate limit result with exceeded limit details and limit values ([721b9e8](https://github.com/emrantusho/vibesdk-project/commit/721b9e8e2e770530465cc37b057760a6c8b9af47))
* enhance security of secrets management system ([078fbee](https://github.com/emrantusho/vibesdk-project/commit/078fbeeb75fdda209036441a4649eb28d074a1ca))
* enhance template file filtering with pattern matching and add nanoid generator ([68678ac](https://github.com/emrantusho/vibesdk-project/commit/68678ac3a06b71d936a8b5f8e9e146b093d6d9a0))
* enhance type exports and improve utility functions for better type safety ([47eba5f](https://github.com/emrantusho/vibesdk-project/commit/47eba5f32ae48efceb07ac9484500cb6e4d3663e))
* expand drizzle types script on sdk bundle ([96b709e](https://github.com/emrantusho/vibesdk-project/commit/96b709e96bb724458bc6bc680bf94f72466c5cb0))
* expand drizzle types script on sdk bundle ([33eb39f](https://github.com/emrantusho/vibesdk-project/commit/33eb39f2d73a3e89b3f83af79566916935c5b9d2))
* extend PR review trigger to include synchronize events ([16e18ba](https://github.com/emrantusho/vibesdk-project/commit/16e18ba8e3514377e75011bd36e1861a6839829d))
* faster blueprint for minimal templates ([1321e43](https://github.com/emrantusho/vibesdk-project/commit/1321e43cdfecfef9bf47a09006c4408ffab1d8dd))
* finish most refactor and get it to build ([d2a7e02](https://github.com/emrantusho/vibesdk-project/commit/d2a7e02105d779b9f6278ea564caa65406225945))
* finish most refactor and get it to build ([5685c7d](https://github.com/emrantusho/vibesdk-project/commit/5685c7d6aa3de016954e09beea6ede46cb1911fd))
* gemini 3 flash ([6452622](https://github.com/emrantusho/vibesdk-project/commit/64526224e96e8284e345bdcc61cdf28d0c49658a))
* general agent ([45eb5c0](https://github.com/emrantusho/vibesdk-project/commit/45eb5c087d3b42651027516edd8c4be34958fc13))
* general agent ([5e4ebb2](https://github.com/emrantusho/vibesdk-project/commit/5e4ebb2e86f7094978499de6796bf3891b19a6ef))
* git repos finally working ([d2e4594](https://github.com/emrantusho/vibesdk-project/commit/d2e4594771869cbc0f3c8140445bb39ac677ddbb))
* implement message deduplication to prevent duplicate assistant responses ([0256634](https://github.com/emrantusho/vibesdk-project/commit/0256634a6a042d7136a6b9bcda80ea92a8d1478c))
* implement phase timeline management and state tracking in SDK ([dbcf51f](https://github.com/emrantusho/vibesdk-project/commit/dbcf51fd16c75886104cb9c4fd2a93b6ba0923b7))
* implement signed URL security for screenshot access ([6da9166](https://github.com/emrantusho/vibesdk-project/commit/6da91663a3ae8588e38534c9bb2643812301d1dc))
* implement WebSocket ticket authentication and management system ([1fe8640](https://github.com/emrantusho/vibesdk-project/commit/1fe8640ddaece52a2befe5a227918831f864c7e0))
* improve AI Gateway token validation and handling ([f0bce24](https://github.com/emrantusho/vibesdk-project/commit/f0bce241777d772a9542ad4336da41d9eded6664))
* improve chat message handling and reconnection flow ([b7e1ae2](https://github.com/emrantusho/vibesdk-project/commit/b7e1ae27b1c1c837abf919be1ad53b899e3420ba))
* improve chat message handling and reconnection flow ([d853266](https://github.com/emrantusho/vibesdk-project/commit/d8532668ec9ff595522c9fe9169b20a74c55baa7))
* improve code regen ([c3baadf](https://github.com/emrantusho/vibesdk-project/commit/c3baadff98b875a8ba8d434cedeba464ab79daa3))
* improve error handling and message display for debugging ([472688d](https://github.com/emrantusho/vibesdk-project/commit/472688dd38f406bad1e6784901ec7124910a11c5))
* improve GitHub Actions workflow reliability ([1e49bb3](https://github.com/emrantusho/vibesdk-project/commit/1e49bb365c83b9e2fdebf76d36b9401479121cdc))
* improve GitHub Actions workflow reliability ([740bf1c](https://github.com/emrantusho/vibesdk-project/commit/740bf1c383f5221ab141fa9b93a6183b65906b2f))
* improve package.json synchronization with sandbox ([a960bc2](https://github.com/emrantusho/vibesdk-project/commit/a960bc2836bfa05da3ee465df7d4d4955f581661))
* improve phase generation and React render loop prevention prompts ([edc9deb](https://github.com/emrantusho/vibesdk-project/commit/edc9deb1e4d243dfb80118ddebcad0b6a50c8c16))
* improve sandbox and git integration ([8044881](https://github.com/emrantusho/vibesdk-project/commit/8044881621661f681a045b6f5af65826c2fd09c1))
* improve sandbox directory handling and error recovery ([eaf5bd5](https://github.com/emrantusho/vibesdk-project/commit/eaf5bd57b78e5a9f2a102f08c2f72ea95e66955e))
* improve SDK error handling and resource cleanup ([17f1d4e](https://github.com/emrantusho/vibesdk-project/commit/17f1d4ed28487cd83da8ba3271c07ef65f30782b))
* improve tab layout and git clone button placement ([8b6f908](https://github.com/emrantusho/vibesdk-project/commit/8b6f9086cf7e319fe7e0e7e758baa371bfd63490))
* improve tab layout and git clone button placement ([c1b8a02](https://github.com/emrantusho/vibesdk-project/commit/c1b8a02c7188789036f1a964a9f80787394d80ee))
* improve template selection reliability and prompt clarity ([8ed1a08](https://github.com/emrantusho/vibesdk-project/commit/8ed1a0840b70f3e48a6245a89d4b4d468093ee97))
* improve tool calling depth handling for debugging ([73af22b](https://github.com/emrantusho/vibesdk-project/commit/73af22b1a43fdb0ed1ebbfbe06df3288b38e25ea))
* improve workflow metadata handling and cryptographic security ([5869e41](https://github.com/emrantusho/vibesdk-project/commit/5869e4123aeffe756b0e2b86597b83b4eade5ec3))
* improve workflow reliability and add nightly branch support ([07d2d09](https://github.com/emrantusho/vibesdk-project/commit/07d2d09d1b65a5673e429f911ec6f770e4d4760d))
* in memory get template details ([e01f067](https://github.com/emrantusho/vibesdk-project/commit/e01f067969e1ad414257a312d7c887216c06fe46))
* increase temperature and reasoning effort for blueprint ([f0ec7c9](https://github.com/emrantusho/vibesdk-project/commit/f0ec7c97c519c3c9c06fc54ca827324a90cc960a))
* initial configuration for 4GB RAM and local D1 ([b580395](https://github.com/emrantusho/vibesdk-project/commit/b58039520cbbf106641a067a4811778dcfd87661))
* integration tests with worker ([f565aff](https://github.com/emrantusho/vibesdk-project/commit/f565aff144bd0c2b6065db9406da269e0d587c9d))
* integration tests with worker ([a68d9cb](https://github.com/emrantusho/vibesdk-project/commit/a68d9cbde5ba14cba53414361bcbefdb41851f9f))
* isolated deepdebug window ([6605ecd](https://github.com/emrantusho/vibesdk-project/commit/6605ecdf51aa6f2c7feacc91ad2f3b1cdfb91127))
* latest packages updated ([e5496e0](https://github.com/emrantusho/vibesdk-project/commit/e5496e0cfd2923acc25d7e4f2265b4a0d7fd69f8))
* limit deep_debug tool to one call per conversation turn ([1b13c71](https://github.com/emrantusho/vibesdk-project/commit/1b13c71b719871fc5c60e1a5e45a08bc90db2456))
* make deterministic code fixer completely sync ([23f0261](https://github.com/emrantusho/vibesdk-project/commit/23f0261d9079c9c2991074180c8b5468af0e085a))
* new zero knowledge vault implementation ([fd28396](https://github.com/emrantusho/vibesdk-project/commit/fd283966ef257178b4332a1c828638d1c3d77f47))
* optimize GitHub push with per-commit trees and blob deduplication ([c73b698](https://github.com/emrantusho/vibesdk-project/commit/c73b698057e7648c4b318f0dc83908797096756e))
* optimize phase context and reduce max phases to 10 ([0557bf7](https://github.com/emrantusho/vibesdk-project/commit/0557bf71c61ba6c7eb68ad07600ef87768366cbb))
* optimize pre-commit hook with selective typecheck and related tests ([1cab335](https://github.com/emrantusho/vibesdk-project/commit/1cab3357291c91f631705a975d4786a5304ed58f))
* phase implementation propmt rewrite - v78 prompt variant ([ffa547e](https://github.com/emrantusho/vibesdk-project/commit/ffa547e3e6fedc07c694052a2added4a810424b9))
* presentation specific prompts + prompts restructuring ([b6abaca](https://github.com/emrantusho/vibesdk-project/commit/b6abaca2cffca283c4e0974905c3a1165542400f))
* presentation specific prompts + prompts restructuring ([0bfcdbb](https://github.com/emrantusho/vibesdk-project/commit/0bfcdbbb52c7707e32b8a0eaf8cc411f107206e5))
* prompt refinements for zustand ([ff604c6](https://github.com/emrantusho/vibesdk-project/commit/ff604c6fafa42be76431d3dd8038edc9b4a71aa5))
* prompt tuning for shorter blueprints ([e9041f1](https://github.com/emrantusho/vibesdk-project/commit/e9041f1793bced58754a177c8a95e2609a5b56de))
* provide git tools to deep_debugger + reset functionality ([0c0a777](https://github.com/emrantusho/vibesdk-project/commit/0c0a7776203fbf728a9ab281206bb5e99f03d35a))
* purely in-isolate template unzip + inmemory storage ([3cd14ed](https://github.com/emrantusho/vibesdk-project/commit/3cd14ed58a4fe786523a4e5c63348c0b2671ee78))
* readme update ([33f72ab](https://github.com/emrantusho/vibesdk-project/commit/33f72ab3dea70c1bc2c13e9ce30f79caa1c99422))
* redact older phase details to optimize context length in prompts ([2cd720e](https://github.com/emrantusho/vibesdk-project/commit/2cd720ea26e6c03dcdeb250b4d93546da1f52d91))
* reduce side of blueprint infer for minimal templates ([3eb0039](https://github.com/emrantusho/vibesdk-project/commit/3eb0039e57bd398afd7b3ea0616f0a532e292a61))
* refactor client methods to include app management functionalities ([b9f0416](https://github.com/emrantusho/vibesdk-project/commit/b9f041655ae82898e757a19be06e9b35f58f98a8))
* refactor file manager to separate state recording from git operations ([e3d0862](https://github.com/emrantusho/vibesdk-project/commit/e3d0862d5daf8cb2a1d1ae3e9e9bff4ee2989abf))
* refine agent model configurations and phase generation strategy ([69c8642](https://github.com/emrantusho/vibesdk-project/commit/69c86425590c108d7926a7c074ee2a830d5aa593))
* remove code-review system in favor of deep-debugger + user prompt ([bafe0d9](https://github.com/emrantusho/vibesdk-project/commit/bafe0d9fe63312895f8df4cfd6ae035d9199cf11))
* remove redundant message and fix file saving in code generation ([6f170e1](https://github.com/emrantusho/vibesdk-project/commit/6f170e1650f60eb1139272352e0ebe34fa31845d))
* replace CLI token authentication with SDK API key management ([30ba991](https://github.com/emrantusho/vibesdk-project/commit/30ba9918fc0eb176c65ff0ff0d4912a425413ecb))
* replace template manager with ai template selector ([ca8e7e4](https://github.com/emrantusho/vibesdk-project/commit/ca8e7e41b7bff0ad64f129138c8c446145597416))
* replace template manager with ai template selector ([234860f](https://github.com/emrantusho/vibesdk-project/commit/234860fe1ff60b5018a9b08d54ece3adfc631aa4))
* reworked github flow, pure DO based + cache token to avoid oauth ([7f33d02](https://github.com/emrantusho/vibesdk-project/commit/7f33d02d4b9cf3408f546fe4efd46b9038b79297))
* rewrite presentation preview system ([09653ba](https://github.com/emrantusho/vibesdk-project/commit/09653ba4e1e5a9a355e88c0c467dceb37fe9f7e8))
* rewrite process monitoring and error handling ([b0db701](https://github.com/emrantusho/vibesdk-project/commit/b0db701e82fad2d00820b7bd127b412017301cce))
* sandboxsdk 0.4.3 port + in-memory template details zip extraction ([fd63813](https://github.com/emrantusho/vibesdk-project/commit/fd638136bc7261869fefbef2692ec488adabc5d9))
* sdk tests ([a841168](https://github.com/emrantusho/vibesdk-project/commit/a8411685ff7ef3fce82aba34534d6145bb2a09fe))
* sdk ws ticket auth and auto reconnect ([932271f](https://github.com/emrantusho/vibesdk-project/commit/932271fd33d9a7f122cd193ae8911195d951339c))
* some prompt improvements ([e136129](https://github.com/emrantusho/vibesdk-project/commit/e1361297a704e78e059bddcffeb5c3f3f3490782))
* some prompt improvements in agentic project builder ([7faf0e0](https://github.com/emrantusho/vibesdk-project/commit/7faf0e03cb1f8b7632d8a2f5ec92afc1cbc62d78))
* static analysis for browser rendered preview projects ([22be3f8](https://github.com/emrantusho/vibesdk-project/commit/22be3f8e74b1897254031dbffa0411893d7a5446))
* static analysis for browser rendered preview projects ([320fc84](https://github.com/emrantusho/vibesdk-project/commit/320fc84454073e2a720deb6dca6deffa8e9060a3))
* suppress AI Gateway token in CI and limit template deploy environment variables ([ee7a83f](https://github.com/emrantusho/vibesdk-project/commit/ee7a83ff1d1e11bbbf7607c4c7a74a75dbef29d1))
* truncate exec command output to prevent token overflow ([2d05283](https://github.com/emrantusho/vibesdk-project/commit/2d0528363c98fc54c4e105e750eda20b8e55b414))
* update model configurations and enhance inference handling ([f7960d5](https://github.com/emrantusho/vibesdk-project/commit/f7960d5b4e5c71297733bd6e3f653253efa14ce8))
* update to latest packages ([9ce7c55](https://github.com/emrantusho/vibesdk-project/commit/9ce7c5509b2055e88e1f546b82563eb4c8825e59))
* updated llm.md and claude.md ([6ae57ef](https://github.com/emrantusho/vibesdk-project/commit/6ae57ef15963102b9524ebdd26e4eda3feabebd9))
* upgraded to sandbox sdk version 0.5.2 ([9f9cc7a](https://github.com/emrantusho/vibesdk-project/commit/9f9cc7aa98be1373db0267b39cb7dd67d82d5dd6))
* use agentic builder directly for handling user messages ([681bbbe](https://github.com/emrantusho/vibesdk-project/commit/681bbbeb7ace71a8cdebb7fc62ed35b99370cb61))
* use agentic builder directly for handling user messages ([06d9ce9](https://github.com/emrantusho/vibesdk-project/commit/06d9ce92c6896677cce47a683d7e85aa02238456))
* use custom isomorphic-git fork + fix fs adapter and integration ([27640b8](https://github.com/emrantusho/vibesdk-project/commit/27640b8020a767cd3e2ccbe0282c8cc961284408))
* use original worker types in sdk ([6745f04](https://github.com/emrantusho/vibesdk-project/commit/6745f0446bb11c6fd99adaddd9c45400a1f33014))
* use original worker types in sdk ([0bc7db9](https://github.com/emrantusho/vibesdk-project/commit/0bc7db9bf354b6160da046cb0a765a1e502f14e5))
* wrap global fetch to preserve context in Workers runtime ([b7be5db](https://github.com/emrantusho/vibesdk-project/commit/b7be5dba23ec03315eb52cc83784699553f56868))


### Bug Fixes

* add additional ownership verification checks ([b74a645](https://github.com/emrantusho/vibesdk-project/commit/b74a645202937d0e8538265c9b7c6467f084655e))
* add ESM type declarations for isomorphic-git and update imports ([5bff523](https://github.com/emrantusho/vibesdk-project/commit/5bff5235f941fa198d93b482b74afcce64a4b716))
* add logs and ownership check for github export ([271b339](https://github.com/emrantusho/vibesdk-project/commit/271b3393dd1383a24830c11dc086d5cf59066203))
* add missing await for async getFullState call in getAgentState function ([b0afd15](https://github.com/emrantusho/vibesdk-project/commit/b0afd1533f736976367e8a3585a7d260d76fd8c4))
* add missing lock changes ([b567804](https://github.com/emrantusho/vibesdk-project/commit/b5678042b61af353a1777695baaaf68f60134ac7))
* add optional chaining to prevent runtime errors in blueprint rendering ([2a2d86c](https://github.com/emrantusho/vibesdk-project/commit/2a2d86c6d2afe45b4445e70d617e39d3367fd90d))
* add optional chaining to prevent runtime errors in blueprint rendering ([bb09d92](https://github.com/emrantusho/vibesdk-project/commit/bb09d9207a715476025accfed8d4fae36143b513))
* add ownership/access checks in git protocol handlers ([ff9643a](https://github.com/emrantusho/vibesdk-project/commit/ff9643afb7d79ac6f58e2b2862b0681e7f94b6f2))
* add setup commands execution after sandbox deployment ([5c471ff](https://github.com/emrantusho/vibesdk-project/commit/5c471ff8ae4d21d678a592e3047b76d5b5153e47))
* Add template migration directly into onStart ([57ee53f](https://github.com/emrantusho/vibesdk-project/commit/57ee53f670178c0e350919d12376e164966a0bf9))
* added auto-build check to launch script ([98a9d01](https://github.com/emrantusho/vibesdk-project/commit/98a9d013e85826bef41a69caee2dfcbb39846004))
* added instructions for token creation ([3544038](https://github.com/emrantusho/vibesdk-project/commit/354403896f81573316f4ec5ec4fb1cae898fb255))
* added instructions for token creation ([f7cc7ea](https://github.com/emrantusho/vibesdk-project/commit/f7cc7ea2bd243eefa176900e820b30b8a61e4c65))
* added instructions for token creation ([ea3f110](https://github.com/emrantusho/vibesdk-project/commit/ea3f110fd9526da2978dd1064d377bf70f0c7c81))
* allow websockets now in prompts ([406761c](https://github.com/emrantusho/vibesdk-project/commit/406761c89679b2a9998861f3eeef6d2b350a2cb8))
* better deduplication of commands for bootstrap file ([27efc11](https://github.com/emrantusho/vibesdk-project/commit/27efc11290e995187daf0a5f3d5b9b63af779aba))
* better stale comment removal + correct YAML string escaping ([834cffa](https://github.com/emrantusho/vibesdk-project/commit/834cffa6968bc71513640e423a8f504f17d4ef9a))
* build errors ([ddd5639](https://github.com/emrantusho/vibesdk-project/commit/ddd56394887abb248f51948d65895539e6736eba))
* build errors ([3898da4](https://github.com/emrantusho/vibesdk-project/commit/3898da495ec78526b36bf8c6657d5b89d45cefac))
* change phase not found from error to warning ([2b78809](https://github.com/emrantusho/vibesdk-project/commit/2b78809a0751f21a1f9637c91cc4238ebfb2bcf1))
* check repo exists before export ([89ace7f](https://github.com/emrantusho/vibesdk-project/commit/89ace7f6a440de8e7f455d433644da26d260126d))
* clarify Cloudflare WARP note in setup documentation for local development ([49c5dd2](https://github.com/emrantusho/vibesdk-project/commit/49c5dd222efe1e89c1ffbc89684183e106e86b41))
* clarify docs and align ([5e1df23](https://github.com/emrantusho/vibesdk-project/commit/5e1df2364181d98adab392e207a6b74aefe8a669))
* cleanup chat.tsx for build ([d80c416](https://github.com/emrantusho/vibesdk-project/commit/d80c41625684f501e59d600593572c3832251638))
* cleanup chat.tsx for build ([670c8d6](https://github.com/emrantusho/vibesdk-project/commit/670c8d6c241d38335676440ecaa6225795ba6f2a))
* client and logger management in DeploymentManager ([2a19261](https://github.com/emrantusho/vibesdk-project/commit/2a192612e0c9c37efabd8712f6804cb184c80745))
* code debugger prompt improvements ([06375ce](https://github.com/emrantusho/vibesdk-project/commit/06375ce09891d311acc8b283391d2378a50f35f0))
* concurrent deploy + use nanoid + stalestate ([ee61d46](https://github.com/emrantusho/vibesdk-project/commit/ee61d464fbcd712a20ff822bdb76e0cf881e1aa3))
* convo id uniqueness and improve message deduplication ([d4ae61d](https://github.com/emrantusho/vibesdk-project/commit/d4ae61d6357d1c107b2ed5148ea5cbb18bfd6248))
* convo id uniqueness and improve message deduplication ([d45f368](https://github.com/emrantusho/vibesdk-project/commit/d45f3688a017496604e6dffe454c083d506fed74))
* correct indentation in vault-context unlock error handler ([f908d31](https://github.com/emrantusho/vibesdk-project/commit/f908d31e0e3956675a9def25e74d1913dbb19b9c))
* correct metadata file path and instance ID generation ([4e932f8](https://github.com/emrantusho/vibesdk-project/commit/4e932f889e7e1630dc1f0693af0b3514c63d69e2))
* corrected wrangler persist flag for local dev ([3f05aa4](https://github.com/emrantusho/vibesdk-project/commit/3f05aa46b19b82274a35709793125fe33b6a6dd5))
* Critical OAuth State Manipulation Vulnerability in GitHub Export ([340c332](https://github.com/emrantusho/vibesdk-project/commit/340c332c62b88a7d0f321d888e2ee1edd318190d))
* detect module-level JSX anti-pattern in safety gate ([37e5ef5](https://github.com/emrantusho/vibesdk-project/commit/37e5ef5edd6c48b075d8cd31b03b40b502a43d2b))
* do not allow non owner to export code to github repo after oauth callback ([0b30b38](https://github.com/emrantusho/vibesdk-project/commit/0b30b38eb51f5b77f1c56aeef3b546d586ab6eba))
* don't wait for runtime errors if app not deployed ([0dd3e7e](https://github.com/emrantusho/vibesdk-project/commit/0dd3e7ef357a0193d6f8f5de9771306ab13754bd))
* dont clear runtime errors on executeDeepDebug ([1eda73e](https://github.com/emrantusho/vibesdk-project/commit/1eda73ef5a57aa6203d9b7dac9d39bf160b2af00))
* ensure workspace directory exists before writing files ([17258f3](https://github.com/emrantusho/vibesdk-project/commit/17258f3094e405360e1461dd04d8ae5b1af4cebd))
* ensure workspace directory exists before writing files ([bb23e88](https://github.com/emrantusho/vibesdk-project/commit/bb23e88aa4b081a70803dc9cb82fe135acb1c456))
* escape single quotes in GitHub workflow commands ([d7e534a](https://github.com/emrantusho/vibesdk-project/commit/d7e534a20696fd07192852e6755fb49aca6dacf6))
* fileRegeneration was using realtimeCodeFixer's model config ([989aa1b](https://github.com/emrantusho/vibesdk-project/commit/989aa1bf9c649558bd4aa959c906cf438be29ef6))
* files format ([da31e76](https://github.com/emrantusho/vibesdk-project/commit/da31e761e6cba4e839f5f0c527410128f5b18fd7))
* files format ([feca8ca](https://github.com/emrantusho/vibesdk-project/commit/feca8ca7c0ac3e4fb1ca6a5d7d859d96236ad53b))
* filter protected files ([ff3a302](https://github.com/emrantusho/vibesdk-project/commit/ff3a302bf8fa3059156c4f10efc30c55aa6f0455))
* filter websocket failed errors ([6df1d30](https://github.com/emrantusho/vibesdk-project/commit/6df1d30cbfc4fe27a7febc5fb72f40e19b9dfbea))
* finish posting to files map ([b73557e](https://github.com/emrantusho/vibesdk-project/commit/b73557e4ed141191aba31a1fd6dceb7cbb86ec14))
* fix all structured format failing tests ([5d6e74f](https://github.com/emrantusho/vibesdk-project/commit/5d6e74fff7abcaa78e06afbb7e57cf260503a4c0))
* fix general agent app creation ([fa080ec](https://github.com/emrantusho/vibesdk-project/commit/fa080ec378a6756584596da800b0944fd83b9099))
* Fixed filtering important files ([d3d4776](https://github.com/emrantusho/vibesdk-project/commit/d3d47769a7331523c2e2cb4c07b5408e3b7c862f))
* fixed github bot's commit mistakes ([a729366](https://github.com/emrantusho/vibesdk-project/commit/a72936654aa13113e4a73d8902bded052566f0cd))
* fixed setup project broken ([6a48871](https://github.com/emrantusho/vibesdk-project/commit/6a4887103e388784def70ee12b15c916ee2b3eb2))
* generation context template details passing ([2b761d0](https://github.com/emrantusho/vibesdk-project/commit/2b761d0d3d45d43206212f1166b98fb8dbcf3732))
* GitHub repository handling for exports to existing repo ([d7c4261](https://github.com/emrantusho/vibesdk-project/commit/d7c4261e527c8b54291d8cc3d703492bf8e19ebc))
* handle missing sandbox instance by returning empty issues object ([1259176](https://github.com/emrantusho/vibesdk-project/commit/1259176c3b77500c4d145207f33d4a29cad20d74))
* handle parent dir creation in sandbox ([262bf69](https://github.com/emrantusho/vibesdk-project/commit/262bf691ace3b66212128f18278e8f9fe348a0ec))
* improve browser rendering checking logic ([fa397bb](https://github.com/emrantusho/vibesdk-project/commit/fa397bb0b44aab332139ce99791bf5816dcec3c7))
* improve shell safety and variable handling in claude-reviews gating ([f656cf0](https://github.com/emrantusho/vibesdk-project/commit/f656cf07d0e1b9d33ea593733ca15b77a715452d))
* improve shell safety and variable handling in claude-reviews gating ([31a1820](https://github.com/emrantusho/vibesdk-project/commit/31a1820c2c3cac6ce7d41401a13565ec2f91f08a))
* improved process monitoring, failure detection and restarts ([ca7d309](https://github.com/emrantusho/vibesdk-project/commit/ca7d309405c4a750f344371caef6a7b95b0714d3))
* jwt oauth state for github oauth to prevent manipulation ([e3a25a8](https://github.com/emrantusho/vibesdk-project/commit/e3a25a80056f413e3163452702f57cec701e90a4))
* log results object correctly and suppress init error propagation in generator agent ([bb0d97e](https://github.com/emrantusho/vibesdk-project/commit/bb0d97e3236bf048f2bb5aa545a1b50fae86e81e))
* manual sync of wrangler and launch scripts ([175a220](https://github.com/emrantusho/vibesdk-project/commit/175a220740f5466144318eacdfb7fb3821ec3f09))
* manual template selection ([e440372](https://github.com/emrantusho/vibesdk-project/commit/e440372760d69e6f587bfcb94d93c7bece39a6b6))
* only app owner should be able to deploy preview ([ba22bf8](https://github.com/emrantusho/vibesdk-project/commit/ba22bf85cdee42c6144ccdfe071b32be36b3e24e))
* only generate AI proxy vars when JWT secret is configured ([701fe81](https://github.com/emrantusho/vibesdk-project/commit/701fe8171b7098f0d470f8a56a9ae50b394f924f))
* Only update dependencies during package.json sync + migrations ([52fdf38](https://github.com/emrantusho/vibesdk-project/commit/52fdf385c4a25ed7e1df8adc1b273ac28c7f7770))
* pass manually selected template and skip ai flow ([ad7ae4e](https://github.com/emrantusho/vibesdk-project/commit/ad7ae4ec992ec85e17d073a15d63b28ba2462671))
* prevent duplicate agent session creation and improve error handling in chat initialization ([40103ef](https://github.com/emrantusho/vibesdk-project/commit/40103ef67687d642b955172f6a841dd3abf6125d))
* prevent race condition in code generation state ([188ba0d](https://github.com/emrantusho/vibesdk-project/commit/188ba0d1bdf7f30fd258275804e311921457d5e9))
* prevent reuse of aborted controllers and improve sandbox deployment resilience ([d5092b0](https://github.com/emrantusho/vibesdk-project/commit/d5092b0c1757071efedd9c5a10677691e5497040))
* preview update fixes + navigation ([5b96591](https://github.com/emrantusho/vibesdk-project/commit/5b96591e074f4fcc7fe15ad14236abf107fd8910))
* prompt react fixes ([0c3a841](https://github.com/emrantusho/vibesdk-project/commit/0c3a841b72497bd97169de907a806d8527ff0abd))
* refine preview switching logic and fix code generation prompt ([a658282](https://github.com/emrantusho/vibesdk-project/commit/a658282b1ca6e364e5dbe374ca75fde12d18ab99))
* refresh to csrf token after register/login ([a1225c8](https://github.com/emrantusho/vibesdk-project/commit/a1225c8b86643280a2b6ac4f0fd73753a8b2c08f))
* remove experimental remote bindings from vite config ([4a180b5](https://github.com/emrantusho/vibesdk-project/commit/4a180b50849a63e35316b458f6e114b7944b648f))
* remove hardcoded models ([b98f862](https://github.com/emrantusho/vibesdk-project/commit/b98f86280dd802cb226dd2d7e836e6ee8b713b5e))
* remove redundant width/height styles from preview iframe ([f1efe5b](https://github.com/emrantusho/vibesdk-project/commit/f1efe5b1905cc59c6ee596183808add37f7a0e00))
* rendering and migration for template details change ([af1ba31](https://github.com/emrantusho/vibesdk-project/commit/af1ba3155e458320abc6d67c60ca7e4276885ec4))
* resolve babel traverse import compatibility and disable phase parameter in safety gate ([c33a972](https://github.com/emrantusho/vibesdk-project/commit/c33a972a4aec6bee0ce056192a0bc75300db5d51))
* simply use git push from isomorphic git to sync with github ([f13fab7](https://github.com/emrantusho/vibesdk-project/commit/f13fab7f97d6f64e6899aeebe22bd51d41d46152))
* stabilize legacy chats and preview rendering ([61421ed](https://github.com/emrantusho/vibesdk-project/commit/61421ed3575209356dc19828c7453b67a2d8d41f))
* standardize isomorphic-git imports and resolve ESM compatibility issues ([9e1a98b](https://github.com/emrantusho/vibesdk-project/commit/9e1a98bb5dcb170b7ccba2c6430dbfeaeea7405d))
* template cache clear before import + init meta in behavior constructor ([c6a329e](https://github.com/emrantusho/vibesdk-project/commit/c6a329e13b34e02da3ff3631b40738154a5de2da))
* template cache clear before import + init meta in behavior constructor ([5deea6a](https://github.com/emrantusho/vibesdk-project/commit/5deea6ae9ba7c831fb275764b3400e068f3f0f1c))
* template import and state init ([9f5f787](https://github.com/emrantusho/vibesdk-project/commit/9f5f787a8c1a40e04e02c220ab3c900eb44b3ca6))
* template import and state init ([060cc9e](https://github.com/emrantusho/vibesdk-project/commit/060cc9e0e5ac5d821f9f1666da229443538a1a38))
* template initialization ([7db6ca2](https://github.com/emrantusho/vibesdk-project/commit/7db6ca2a7d8f9f6e418e38379a5e25f0caaf5c0d))
* template initialization ([e8d07af](https://github.com/emrantusho/vibesdk-project/commit/e8d07affe902bab37aa585ce58d3915b08139893))
* try use github_token instead of odic ([cdc68c5](https://github.com/emrantusho/vibesdk-project/commit/cdc68c569c9595abaa6ead331845058e0672021c))
* tune deep debug config ([6d361eb](https://github.com/emrantusho/vibesdk-project/commit/6d361eb1cd4218a4ec7a2c1ec5d1bcc276d1b64b))
* typeScript features configurable to reduce memory ([d3f984c](https://github.com/emrantusho/vibesdk-project/commit/d3f984c3fd8e5ce4909f5849b97c3ecd3b900dd2))
* ui and convo state management ([0323c7a](https://github.com/emrantusho/vibesdk-project/commit/0323c7a04e20a6abae41ee1ca7483b6360e4698f))
* ui and convo state management ([bbf1979](https://github.com/emrantusho/vibesdk-project/commit/bbf19790004dc570b33dce07399c59276809e1fd))
* ui auto focus, preview hiding and blueprints ([cfe24e3](https://github.com/emrantusho/vibesdk-project/commit/cfe24e3e99b418bca97cd4d5bd8d30602a6a7ebe))
* ui auto focus, preview hiding and blueprints ([868ba34](https://github.com/emrantusho/vibesdk-project/commit/868ba34aae25855791f24dff41bebf6ff6f4cb8f))
* unescape commit messages before git operations ([d51310b](https://github.com/emrantusho/vibesdk-project/commit/d51310b77723c87749a34c20b78a415054298eaa))
* update migration command to include local migrations ([78929ef](https://github.com/emrantusho/vibesdk-project/commit/78929ef12b8a280d7ce8aeda4c51f3175a687b55))
* update setup documentation and script to address Cloudflare WARP issues and add tunnel preview option ([84c3f2d](https://github.com/emrantusho/vibesdk-project/commit/84c3f2d04d6942bbb185463758e7467745f2fb2a))
* updated sandbox dockerfile ([34d5988](https://github.com/emrantusho/vibesdk-project/commit/34d598836b9f33a94eab0650c2dfafdffcf02bfc))
* updated sandbox dockerfile ([0ee9218](https://github.com/emrantusho/vibesdk-project/commit/0ee9218fc567308224158a0d27d71c73cef9c482))
* use safeFiles instead of finalFiles for phase implementation logging and broadcast ([849fdce](https://github.com/emrantusho/vibesdk-project/commit/849fdced2ad43dbf79be8d44d74f3524b2bb7f70))
* use templateName check instead of isInitialized() for agent start validation ([d9c7a30](https://github.com/emrantusho/vibesdk-project/commit/d9c7a30732b5dcc5baf6c39635332ebe1030f9cd))
* variable name mismatch in simple code generation operation ([22b8f00](https://github.com/emrantusho/vibesdk-project/commit/22b8f0082ab0817be9fd9571c6d0806c49c1180a))
* wire up onConnect to coding agent ([318f6e2](https://github.com/emrantusho/vibesdk-project/commit/318f6e2620654e3c442c5926c84a296bd940d619))
* wire up onConnect to coding agent ([40ab40e](https://github.com/emrantusho/vibesdk-project/commit/40ab40ec472d68f0f6bc1ffb3460593d5b94aa92))


### Performance Improvements

* optimize binary file detection and base64 encoding in zip extractor ([a6c67d0](https://github.com/emrantusho/vibesdk-project/commit/a6c67d01be38e235207a647b83dd5dde0167dd49))
* optimize file operations and reduce unnecessary commits ([650b967](https://github.com/emrantusho/vibesdk-project/commit/650b967bbbd760a91a29f97a9700801bdecb5539))
* optimize file writing with batched shell script to reduce API requests ([f4f4f7b](https://github.com/emrantusho/vibesdk-project/commit/f4f4f7ba2ac441612f6cbae7a20e3c54da882231))
* optimize git clone by only including reachable objects ([4716f4e](https://github.com/emrantusho/vibesdk-project/commit/4716f4e49e483ae71f4e3e5513ad310c1429d3a8))


### Reverts

* remove USE_AGENT_SDK flag from Claude Code Action workflows ([1380279](https://github.com/emrantusho/vibesdk-project/commit/13802798cf81fafa756d2d6c5030ea837db2fe00))
